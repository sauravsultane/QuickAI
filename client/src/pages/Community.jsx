      ...
      <div className="bg-white h-full w-full rounded-xl overflow-y-scroll flex flex-wrap">
        {creations.map((creation, index) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 flex gap-2 items-end justify-end p-3 group-hover:justify-between group-hover:bg-gradient-to-b from-transparent to-black/80 text-white rounded-lg">
